 ...
 */
class User extends \Bs\FrontOfficeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'iduser', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'login', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'datenaissance', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'cin', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'codepostale', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'nbreenfant', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'typeuser', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'etat', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\User' . "\0" . 'note');
        }

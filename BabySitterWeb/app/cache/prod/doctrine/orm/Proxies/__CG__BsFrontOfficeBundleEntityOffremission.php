 ...
 */
class Offremission extends \Bs\FrontOfficeBundle\Entity\Offremission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'numoffre', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'date', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'description', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'adresse', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'horaire', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'typeuser', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Offremission' . "\0" . 'iduser');
        }

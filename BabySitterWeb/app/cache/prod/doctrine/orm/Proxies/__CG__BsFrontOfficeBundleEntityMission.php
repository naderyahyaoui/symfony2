 ...
 */
class Mission extends \Bs\FrontOfficeBundle\Entity\Mission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'idmission', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'date', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'description', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'adresse', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'horaire', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'iduser', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Mission' . "\0" . 'typeuser');
        }

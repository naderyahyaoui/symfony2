 ...
 */
class Newsletter extends \Bs\BackOfficeBundle\Entity\Newsletter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'idnewsletter', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'addressdest', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'addresseexp', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'objet', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'contenu', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Newsletter' . "\0" . 'file');
        }

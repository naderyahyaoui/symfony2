 ...
 */
class Garderie extends \Bs\BackOfficeBundle\Entity\Garderie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'idgarderie', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'nomgarderie', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'description', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'tarif', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'codepostale', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'nomresponsable', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Garderie' . "\0" . 'iduser');
        }

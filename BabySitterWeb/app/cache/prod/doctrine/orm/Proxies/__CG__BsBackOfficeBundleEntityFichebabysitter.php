 ...
 */
class Fichebabysitter extends \Bs\BackOfficeBundle\Entity\Fichebabysitter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'idfiche', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'nom', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'titre', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'experience', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'consigne', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'prenom', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'photo', '' . "\0" . 'Bs\\BackOfficeBundle\\Entity\\Fichebabysitter' . "\0" . 'iduser');
        }

 ...
 */
class Reclamation extends \Bs\FrontOfficeBundle\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'idreclamation', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'titre', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'message', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'typeuser', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'datereclamation', '' . "\0" . 'Bs\\FrontOfficeBundle\\Entity\\Reclamation' . "\0" . 'iduser');
        }

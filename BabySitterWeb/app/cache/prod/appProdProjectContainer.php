...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'BsBackOfficeBundle' => 'Bs\\BackOfficeBundle\\BsBackOfficeBundle',
            ),
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\Bs\\FrontOfficeBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\Bs\\BackOfficeBundle\\Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Bs\\FrontOfficeBundle\\Entity');
        $c->addDriver($b, 'Bs\\BackOfficeBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BsFrontOfficeBundle' => 'Bs\\FrontOfficeBundle\\Entity', 'BsBackOfficeBundle' => 'Bs\\BackOfficeBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.default_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir('C:/wamp/www/BabySitterWeb/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Bs\\BackOfficeBundle/Resources/views'), 'BsBackOffice');
